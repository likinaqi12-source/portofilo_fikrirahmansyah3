      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
        ...
        >
          ...
          <div className="flex gap-5 items-center text-brand-text/60">
            <a href="https://github.com/likinaqi12" target="_blank" rel="noopener noreferrer" className="hover:text-brand-purple transition-colors" title="GitHub">
